...
func NewRuleSetProvider(name string, behavior P.RuleBehavior, format P.RuleFormat, interval time.Duration, vehicle P.Vehicle, filter []string, parse common.ParseRuleFunc) P.RuleProvider {
	rp := &ruleSetProvider{
